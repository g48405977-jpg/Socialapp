...
def send_message(username):
    ...
    if content or image_path or voice_path:
        ...
        cursor = conn.execute(
            ...
            (sender, receiver, content, image, voice, reply_to)
            VALUES (?, ?, ?, ?, ?, ?)
            """,
            (
                session["username"],
